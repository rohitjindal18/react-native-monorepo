...
class GreenScreen extends Component {
    ...
    render() {
        ...
        <View style={styles.green}>
            <Text style={styles.text}>This is the Green {this.props.index || 3} Screen</Text>
            <TouchableHighlight
                style={styles.button}
                onPress={() => this.setBottom()}>
        ...
        <NavigationContainer
          ...
          >
            <Stack.Navigator>
                ...
                <Stack.Screen name='green' options={{

                }} component={GreenScreen}></Stack.Screen>
  ...
  return(
      <NavigationNativeContainer independent={true}>
          <BottomStack.Navigator>
            <BottomStack.Screen name='bottom' options={{
              headerShown: false,
              stackPresentation: 'transparentModal'
